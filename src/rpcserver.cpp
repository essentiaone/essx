...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getblockheaders", &getblockheaders, false, false, false},
        ...
        /* ESS features */
		{"ess", "debug", &debug, true, true, false },
		{"ess", "masternode", &masternode, true, true, false },
		{"ess", "allocatefunds", &allocatefunds, true, true, false },
		{"ess", "fundmasternode", &fundmasternode, true, true, false },
		{"ess", "listmasternodes", &listmasternodes, true, true, false},
        {"ess", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ess", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ess", "masternodecurrent", &masternodecurrent, true, true, false},
        // {"ess", "masternodedebug", &masternodedebug, true, true, false},
        {"ess", "startmasternode", &startmasternode, true, true, false},
        {"ess", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ess", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ess", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ess", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ess", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ess", "getmasternodescores", &getmasternodescores, true, true, false},
        //{"ess", "mnbudget", &mnbudget, true, true, false},
        //{"ess", "preparebudget", &preparebudget, true, true, false},
        //{"ess", "submitbudget", &submitbudget, true, true, false},
        //{"ess", "mnbudgetvote", &mnbudgetvote, true, true, false},
        //{"ess", "getbudgetvotes", &getbudgetvotes, true, true, false},
        //{"ess", "getnextsuperblock", &getnextsuperblock, true, true, false},
        //{"ess", "getbudgetprojection", &getbudgetprojection, true, true, false},
        //{"ess", "getbudgetinfo", &getbudgetinfo, true, true, false},
        //{"ess", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        //{"ess", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"ess", "checkbudgets", &checkbudgets, true, true, false},
        {"ess", "mnsync", &mnsync, true, true, false},
        {"ess", "spork", &spork, true, true, false},
        {"ess", "getpoolinfo", &getpoolinfo, true, true, false},
...
#ifdef ENABLE_WALLET
        // {"ess", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use essd, or the -server option to ess-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"ESS Alert\" admin@foo.com\n"),
...
{
    return "> ess-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41313/\n";
}
