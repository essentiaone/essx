...
// Possible states for zESS send
enum ZerocoinSpendStatus {
    ZESS_SPEND_OKAY = 0,                            // No error
    ZESS_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZESS_WALLET_LOCKED = 2,                         // Wallet was locked
    ZESS_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZESS_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZESS_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZESS_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZESS_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZESS_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZESS_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZESS_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZESS_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZESS_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZESS_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZESS_SPENT_USED_ZESS = 14,                      // Coin has already been spend
    ZESS_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZEssAutoBackups(bool fEnabled)
    {
