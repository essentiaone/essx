...
*Setup instructions for a Gitian build of Ess Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Ess
...
- [Building Ess Core](#building-Ess-core)
...
Clone the git repositories for Ess Core and Gitian.
...
in the Ess Core repository under 'Fetch and create inputs' to install sources which require
...
To build Ess Core (for Linux, OS X and Windows):
...
`./bin/gbuild --commit ess=${COMMIT} ../Ess/ess/contrib/gitian-descriptors/gitian-linux.yml`
`./bin/gbuild --commit ess=${COMMIT} ../Ess/ess/contrib/gitian-descriptors/gitian-osx.yml`
`./bin/gbuild --commit ess=${COMMIT} ../Ess/ess/contrib/gitian-descriptors/gitian-win.yml`

instead of `${COMMIT}` you can specify any branch or tag, for instance: `ess=master`
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Ess/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/essentiaone/Ess
...
For example:
```bash
URL=https://github.com/crowning-/essx.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit ess=${COMMIT} --url Ess=${URL} ../Ess/ess/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit ess=${COMMIT} --url Ess=${URL} ../Ess/ess/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit ess=${COMMIT} --url Ess=${URL} ../Ess/ess/contrib/gitian-descriptors/gitian-osx.yml
```
