Contributing to ESS Core
============================

The ESS Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the ess unit tests or QA tests
...
The following applies to code changes to the ESS Core project, and is not to be
confused with overall ESS Network Protocol consensus changes.

Whether a pull request is merged into ESS Core rests with the project merge
...
Patches that change ESS consensus rules are considerably more involved than
...
Where a patch set proposes to change the ESS consensus, it must have been
...
The project leader is the release manager for each ESS Core release.
