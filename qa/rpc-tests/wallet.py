...
#   c) node1 mines 32 blocks, so now node 0 has 60001 ess, node 1 has 4250 ess, node2 has none.
#   d) node0 sends 601 ess to node2, in two transactions (301 ess, then 300 ess).
